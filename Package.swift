...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "KeynoteModule", dependencies: ["Core"]),
        .target(name: "PagesModule", dependencies: ["Core"]),
        .target(name: "NumbersModule", dependencies: ["Core"]),
        .executableTarget(
            name: "MacCLI",
            dependencies: ["Core", "CalendarModule", "RemindersModule", "ContactsModule", "MailModule", "MessagesModule", "NotesModule", "MusicModule", "TVModule", "ShortcutsModule", "CallModule", "FinderModule", "KeynoteModule", "PagesModule", "NumbersModule"],
            exclude: ["Info.plist"],
            linkerSettings: [
                .unsafeFlags([
                    "-Xlinker", "-sectcreate",
        ...
        .testTarget(name: "KeynoteModuleTests", dependencies: ["KeynoteModule"]),
        .testTarget(name: "PagesModuleTests", dependencies: ["PagesModule"]),
        .testTarget(name: "NumbersModuleTests", dependencies: ["NumbersModule"]),
    ]
)
